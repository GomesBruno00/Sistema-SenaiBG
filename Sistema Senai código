...
<body>
    ...
    <header>
        ...
        <nav aria-label="Navegação Principal">
            <ul>
                ...
                <li><a href="#instrucoes">Procedimentos</a></li>
            </ul>
        </nav>
    </header>
    ...
    <main>
        ...
        <!-- SEÇÃO 1: DASHBOARD DE OS -->
        <section id="dashboard">
            <h2>Ordens de Serviço em Aberto</h2>

            <table>
                <caption>
                    Lista de manutenções preventivas e corretivas da fábrica
                </caption>
        ...
        <!-- SEÇÃO 2: FORMULÁRIO COMPLEXO DE OS -->
        <section id="nova-os">
            ...
            <form action="#" method="POST" enctype="multipart/form-data">
                ...
                <fieldset>
                    ...
                    <label for="foto-laudo">
                        Anexar Foto/Laudo Técnico (PDF ou Imagem):
                    </label><br>
                    ...
                    <textarea
                        ...
                        required
                        minlength="20"
                        placeholder="Descreva o problema no mínimo 20 caracteres."
                    ></textarea><br>
                </fieldset>
    ...
    <aside id="instrucoes">
        ...
        <p>
            Assista ao treinamento rápido de Lockout/Tagout antes de intervir no equipamento:
        </p>

        <figure>
            <video controls width="280">
                <source
                    src="seguranca-manutencao.mp4"
                    type="video/mp4"
                >
            ...
            <figcaption>
                Treinamento de Segurança Obrigatório NR-12
            </figcaption>
        </figure>
    </aside>
    ...
    <footer>
        <p>
            &copy; 2026 Planta Industrial Didática SENAI. Todos os direitos reservados.
        </p>
    </footer>
